...
GN_GROUPS=8
BATCH=32; LR=1e-4; EPOCHS=150; DROPOUT=0.1
...
def main():
    ...
    print("="*70);print("  BASELINE_V2 — 6-stream GroupNorm + CHM stats + 11K aug");print("="*70,flush=True)
    ...
    fold=os.path.join(EXPORT,'fold_full');os.makedirs(fold,exist_ok=True)
    tsc={}
    for c in TARGETS:
    ...
    plt.xlabel('Epoch');plt.ylabel('SmoothL1');plt.title('BASELINE_V2 loss')
